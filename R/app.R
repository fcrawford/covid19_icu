 ...
 titlePanel("COVID-19 Hospital Capacity Model"),
  sidebarLayout(
	...
	conditionalPanel(
		...
		sliderInput("floordeath_medium", "Probability of death on the Floor (18-64 years)",     min=0, max=1, value=params$p_death_floor2),
		sliderInput("floordeath_old", "Probability of death on the Floor ICU (65+ years)",     min=0, max=1, value=params$p_death_floor3),
