...
params_rmd =update_inputs(t=params$t,
                    ...
                    #####################
                    avg_LOS_ICU1=params$avg_LOS_ICU1,
                    avg_LOS_Floor1=params$avg_LOS_Floor1,
                    avg_LOS_ICU2=params$avg_LOS_ICU2,
                    avg_LOS_Floor2=params$avg_LOS_Floor2,
                    avg_LOS_ICU3=params$avg_LOS_ICU3,
                    avg_LOS_Floor3=params$avg_LOS_Floor3,
                    agespecificLOS=params$agespecificLOS)

#dynamicModel = 0

txt <- text_hospital(doprotocols=params$doprotocols,
                     params = params_rmd,
                     dynamicModel=params$dynamicModel)
